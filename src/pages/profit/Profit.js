...
export default function Profit() {
  ...
  return (
    <div className={styles.cont}>
      <div className={styles.panel_cont}>
        <div className={styles.first_panel}>
          <p className={styles.title_first_panel}>Приборная панель</p>
          <div className={styles.panel_points_cont}>
            <div className={styles.point_panel}>
              Публикация
              <img
                className={styles.panel_point_img}
                src="\images\Profit\greenpoint.svg"
              ></img>
            </div>
            <div className={styles.point_panel}>
              Ресурсы
              <img
                className={styles.panel_point_img}
                src="\images\Profit\bluepoint.svg"
              ></img>
            </div>
          </div>
        </div>
        <div className={styles.second_cont}>
          <div className={styles.secont_left_cont}>
            <div className={styles.left_up}>
              <div className={styles.left_up_info}>
                <p>Ресурсы</p>
                <p className={styles.left_up_price}>1,569.00 $</p>
              </div>
              <div className={styles.left_up_info}>
                <p>Публикации</p>
                <p className={styles.left_up_price}>290</p>
              </div>
              <div className={styles.left_up_info}>
                <p>Продажи</p>
                <p className={styles.left_up_price}>69</p>
              </div>
            </div>
            <div className={styles.left_bot}>
              <button className={styles.send_post}>
                Разместить статью
                <img
                  className={styles.send_img}
                  src="\images\Profit\pageico.svg"
                ></img>
              </button>
              <button
              ...
              >
                ...
                <img
                  className={styles.send_img}
                  src="\images\Profit\plusico.svg"
                ></img>
              </button>
            </div>
          </div>
          <div className={styles.second_right_cont}></div>
        </div>
      </div>
      <div className={styles.pub_cont}>
            ...
            >
              ...
              <div className={styles.status_cont}>
                <img
                  ...
                  src={`/images/Mypub/status_${card.status_num}.svg`}
                  alt={`status ${card.status_num}`}
                />
              </div>
              <img
